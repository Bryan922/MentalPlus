// Script pour créer automatiquement toutes les tables MentalSerenity
const { createClient } = require('@supabase/supabase-js')

// Configuration Supabase (utilisez vos vraies clés)
const SUPABASE_URL = 'https://xfippugvmgnsmxssptmm.supabase.co'
const SUPABASE_SERVICE_KEY = 'VOTRE_CLE_SERVICE_SUPABASE' // Remplacez par votre clé service

// Créer le client Supabase avec la clé service pour avoir les permissions admin
const supabase = createClient(SUPABASE_URL, SUPABASE_SERVICE_KEY)

// Script SQL pour créer toutes les tables
const createTablesSQL = `
-- Script pour créer toutes les tables MentalSerenity (version sécurisée)
...
async function createTables() {
    try {
        ...
        const { data: tables, error: tablesError } = await supabase
            ...
            .in('table_name', [
                'clients', 'employees', 'appointments', 'payments', 'consultations', 
                'follow_ups', 'documents', 'messages', 'contact_messages', 'notifications', 
                'availabilities', 'unavailabilities', 'pricing', 'statistics'
            ])
        ...
        console.log('🎉 Base de données MentalSerenity prête !')
